Public Class Form1
    Private TargetDevice As Dataq.Devices.DI4108.Device
    ...
    Function SampleRateBad() As Boolean
        ...
        SampleRateRange = CType(TargetDevice.Channels(0),
        Dataq.Devices.Dynamic.IReadOnlyChannelSampleRate).GetSupportedSampleRateRange(TargetDevice)
        ...
        If Not (SampleRateRange.ContainsValue(tbSampleRate.Text)) Then
            MessageBox.Show("Selected sample throughput rate is outside the range of " + (Math.Truncate(SampleRateRange.Minimum) + 1).ToString + " to " + Math.Truncate(SampleRateRange.Maximum).ToString + " Hz inclusive for your current channel settings.", "Sample Rate Error",
    ...
    Sub ConfigureDigitalChannels()
        Dim DigitalInChan As Dataq.Devices.DI4108.DigitalIn
        Dim DigitalOutChan As Dataq.Devices.DI4108.DigitalOut
        Dim RateInChan As Dataq.Devices.DI4108.FrequencyIn
        Dim CountInChan As Dataq.Devices.DI4108.CounterIn

        'configure digtial port 0
        If cbD0.Checked Then
            Select Case True
                Case cmbD0Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 0),
                    Dataq.Devices.DI4108.DigitalOut)

                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 0),
                    Dataq.Devices.DI4108.DigitalOut)
                Case Else 'else has to be an input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 0),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD1.Checked Then
            Select Case True
                Case cmbD1Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 1),
                    Dataq.Devices.DI4108.DigitalOut)
                Case Else 'else has to be an input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 1),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD2.Checked Then
            Select Case True
                Case cmbD2Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 2),
                    Dataq.Devices.DI4108.DigitalOut)
                Case cmbD2Mode.Text.Contains("Rate")
                    'rate channels are identified in logical order, so this is rate channel 1
                    RateInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.FrequencyIn), 1),
                    Dataq.Devices.DI4108.FrequencyIn)
                ...
                Case Else 'else has to be a discrete input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 2),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD3.Checked Then
            Select Case True
                Case cmbD3Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 3),
                    Dataq.Devices.DI4108.DigitalOut)
                Case cmbD3Mode.Text = "Count"
                    'count channels are identified in logical order, so this is count channel 1
                    CountInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.CounterIn), 1),
                    Dataq.Devices.DI4108.CounterIn)
                Case Else 'else has to be a discrete input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 3),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD4.Checked Then
            Select Case True
                Case cmbD4Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 4),
                    Dataq.Devices.DI4108.DigitalOut)
                Case Else 'else has to be an input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 4),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD5.Checked Then
            Select Case True
                Case cmbD5Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 5),
                    Dataq.Devices.DI4108.DigitalOut)
                Case Else 'else has to be an input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 5),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
        ...
        If cbD6.Checked Then
            Select Case True
                Case cmbD6Mode.Text = "Switch"
                    DigitalOutChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalOut), 6),
                    Dataq.Devices.DI4108.DigitalOut)
                Case Else 'else has to be an input
                    DigitalInChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.DigitalIn), 6),
                    Dataq.Devices.DI4108.DigitalIn)
            End Select
        End If
    End Sub
    ...
    Sub ConfigureAnalogChannels()
        ...
        Dim AnalogChan As Dataq.Devices.DI4108.AnalogVoltageIn

        If cbCH1.Checked Then
            'configure analog channel 1
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 1),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH1.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCh1Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCh1Range.Text, "Maximum")
        End If

        If cbCH2.Checked Then
            'configure analog channel 2
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 2),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH2.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCh2Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCh2Range.Text, "Maximum")
        End If

        If cbCH3.Checked Then
            'configure analog channel 3
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 3),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH3.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCh3Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCh3Range.Text, "Maximum")
        End If

        If cbCH4.Checked Then
            'configure analog channel 4
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 4),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH4.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCh4Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCh4Range.Text, "Maximum")
        End If
        If cbCH5.Checked Then
            'configure analog channel 4
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 5),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH5.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCH5Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCH5Range.Text, "Maximum")
        End If
        If cbCH6.Checked Then
            'configure analog channel 4
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 6),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH6.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCH6Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCH6Range.Text, "Maximum")
        End If
        If cbCH7.Checked Then
            'configure analog channel 4
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 7),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH7.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCH7Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCH7Range.Text, "Maximum")
        End If
        If cbCH8.Checked Then
            'configure analog channel 4
            AnalogChan = CType(TargetDevice.ChannelFactory(GetType(Dataq.Devices.DI4108.AnalogVoltageIn), 8),
            Dataq.Devices.DI4108.AnalogVoltageIn)
            AnalogChan.AcquisitionMode = Text2AcquisitionMode(cmbCH8.Text)
            AnalogChan.HardwareRange.Minimum = Text2Range(cmbCH8Range.Text, "Minimum")
            AnalogChan.HardwareRange.Maximum = Text2Range(cmbCH8Range.Text, "Maximum")
        End If
    End Sub
    Private Function Text2Range(text As String, Boundary As String) As Double
        Select Case True
            Case text = "±0.2"
            ...
            Case text = "±5"
                ...
                Else
                    Return 5
                End If
            Case Else '±10.0 V range is the only remaining possibility
                If Boundary = "Minimum" Then
                    Return -10
                Else
                    Return 10
        ...
        End Select
    End Function
    Private Function Text2AcquisitionMode(text As String) As Dataq.Devices.IAcquisitionModeType
        Select Case True
            Case text = "CIC filter"
                Return New Dataq.Devices.DI4108.CascadedIntegratorCombFilter
            Case text = "Maximum"
                Return New Dataq.Devices.DI4108.MaximumSample
            Case text = "Minimum"
                Return New Dataq.Devices.DI4108.MinimumSample
        End Select
        Return New Dataq.Devices.DI4108.LastSample
    End Function
    ...
    Private Sub Form1_FormClosing(sender As Object, e As EventArgs) Handles MyBase.FormClosing
        ...
        End If
        Dataq.Misc.Miscellaneous.AppExitCleanup()
    End Sub
    Private Async Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmbCh1Range.SelectedIndex = 0
        cmbCh2Range.SelectedIndex = 0
        cmbCh3Range.SelectedIndex = 0
        cmbCh4Range.SelectedIndex = 0
        cmbCH5Range.SelectedIndex = 0
        cmbCH6Range.SelectedIndex = 0
        cmbCH7Range.SelectedIndex = 0
        cmbCH8Range.SelectedIndex = 0

        ' Get a list of devices with model DI-4108

        Dim AllDevices As IReadOnlyList(Of Dataq.Devices.IDevice) =
            Await Dataq.Misc.Discovery.ByModelAsync(GetType(Dataq.Devices.DI4108.Device))

        If AllDevices.Count > 0 Then
            tbOutput.AppendText("Found a DI-4108." + Environment.NewLine)
            ' Cast first device from generic device to specific DI-4108 type
            TargetDevice = CType(AllDevices(0), Dataq.Devices.DI4108.Device)
        ...
        Else
            tbOutput.AppendText("No DI-4108 found." + Environment.NewLine)
            MessageBox.Show("Please connect a compatible instrument and restart",
                                    "No Compatible Instruments Detected", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Finalize()
            End
        End If
    ...
    Private Async Sub btnDigOut_Click(sender As Object, e As EventArgs) Handles btnDigOut.Click
        ...
        For Each chan In TargetDevice.Channels
            If TypeOf chan Is Dataq.Devices.DI4108.DigitalOut Then
                Dim temp As Dataq.Devices.DI4108.DigitalOut =
                CType(chan, Dataq.Devices.DI4108.DigitalOut)
    ...
    Private Sub cbD3_CheckedChanged(sender As Object, e As EventArgs) Handles cbD3.CheckedChanged
        ...
        If cmbD3Mode.Text = "Count" Then
            btnReset.Enabled = cbD3.Checked
        End If
    End Sub
    ...
    Private Sub cbCH1_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH1.CheckedChanged
        cmbCH1.Enabled = cbCH1.Checked
        cmbCh1Range.Enabled = cbCH1.Checked
    End Sub

    Private Sub cbCH2_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH2.CheckedChanged
        cmbCH2.Enabled = cbCH2.Checked
        cmbCh2Range.Enabled = cbCH2.Checked
    End Sub

    Private Sub cbCH3_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH3.CheckedChanged
        cmbCH3.Enabled = cbCH3.Checked
        cmbCh3Range.Enabled = cbCH3.Checked
    End Sub

    Private Sub cbCH4_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH4.CheckedChanged
        cmbCH4.Enabled = cbCH4.Checked
        cmbCh4Range.Enabled = cbCH4.Checked
    End Sub

    Private Sub cbCH5_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH5.CheckedChanged
        cmbCH5.Enabled = cbCH5.Checked
        cmbCH5Range.Enabled = cbCH5.Checked
    End Sub

    Private Sub cbCH6_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH6.CheckedChanged
        cmbCH6.Enabled = cbCH6.Checked
        cmbCH6Range.Enabled = cbCH6.Checked
    End Sub

    Private Sub cbCH7_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH7.CheckedChanged
        cmbCH7.Enabled = cbCH7.Checked
        cmbCH7Range.Enabled = cbCH7.Checked
    End Sub

    Private Sub cbCH8_CheckedChanged(sender As Object, e As EventArgs) Handles cbCH8.CheckedChanged
        cmbCH8.Enabled = cbCH8.Checked
        cmbCH8Range.Enabled = cbCH8.Checked
    End Sub
    ...
    Private Async Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        Await TargetDevice.Protocol.SendResetCounterAsync
    End Sub
    ...
    Private Async Sub btnState_Click(sender As Object, e As EventArgs) Handles btnState.Click
        ...
        Else
            ...
            Dim FirstInChannel As Dataq.Devices.DI4108.ChannelIn
                                    ...
                                    While TargetDevice.IsAcquiring
                                        ...
                                        For index = 0 To MasterChannel.DataIn.Count - 1 ' this is the row (scan) counter
                                            ...
                                            (TypeOf ch Is Dataq.Devices.IFrequency) Then
                                                ...
                                                Else
                                                    'must be dig out, so don't output anything to the display
                                                    Continue For
                                                End If
                                                temp1 = temp1 + ", "
    ...
    Private Sub CmbCH1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCH1.SelectedIndexChanged
